            ...
            Column{
                if (riskLevel == null) {
                    ...
                    Row(
                        ...
                        Text(
                            text = "Score: ${riskLevel.lowercase().replaceFirstChar {
                ...
                Text(
                    text = "Last updated: ${LocalDateTime.now().format(DateTimeFormatter.ofPattern("MMMM dd, HH:mm"))}",
                    fontSize = 15.sp,
                    color = Color.Gray
                )
            }
            if (riskLevel != null && riskLevel == "GOOD"){
                Box(
                    ...
                    modifier = Modifier
                        ...
                        .height(60.dp)
                        .clip(RoundedCornerShape(50f))
                        .background(color = StarlingGoodRisk)
                ) {
                ...
                Box(
                    ...
                    modifier = Modifier
                        ...
                        .height(60.dp)
                        .clip(RoundedCornerShape(50f))
                        .background(color = StarlingLowRisk)
                ) {
                ...
                Box(
                    ...
                    modifier = Modifier
                        ...
                        .height(60.dp)
                        .clip(RoundedCornerShape(50f))
                        .background(color = StarlingMedRisk)
                ) {
            ...
            Row(
                ...
                for (day in daysActive) {
                    if (day.dayIndex > getActiveDOW()) {
                        ...
                        Box(
                            modifier = Modifier
                                .clip(shape = RoundedCornerShape(60f))
                                .background(color = StarlingBlue)
                        ) {
                            Column(
                                horizontalAlignment = Alignment.CenterHorizontally,
...
fun CircleWithBorder(
    ...
    Canvas(
        ...
        drawCircle(
            color = fillColor,
            center = center,
            radius = radiusFloat - (borderWidth / 2).toPx() // Adjust radius to fit inside border
        )
    }
}