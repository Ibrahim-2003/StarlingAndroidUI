package com.example.ibrahimstarlingui.ui.theme
...
val StarlingCheckedTrack = Color(0xFFDFDEEF)
val StarlingUncheckedTrack = Color(0xFFE7DFEC)
val StarlingBackground = Color(0xFFEEF1FC)
val StarlingSettingBackground = Color(0xFFF2F2F7)
